        ...
        <section>
            ...
            <div className='form__edit--container'>
                <div className='form__container'>
                    ...
                    <textarea type="text" placeholder='Method' id='#method' className='form__input' rows="10" readOnly disabled />

                    <label htmlFor="Category" className='form__label'>Recipe Category</label>
                    <input type="text" placeholder='Recipe Category' id='#Category' className='form__input'  readOnly disabled/>
                </div>
                ...
                <div className='form__container container__small' style={{marginLeft: '1rem'}}>
                    ...
                    <input type="text" placeholder='Status' id='#Status' className='form__input'  readOnly disabled/>

                    <label htmlFor="user" className='form__label'>Added by user</label>
                    <input type="text" placeholder='Added by user' id='#user' className='form__input'  readOnly disabled/>

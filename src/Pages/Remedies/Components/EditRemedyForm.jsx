...
import IngrediantTable from './IngrideantTable/IngrediantTable';
import IngridiantFrom from './IngrideantTable/IngridiantFrom';
import RemedyForm from './RemedyForm';

const EditRemedyForm = () => {

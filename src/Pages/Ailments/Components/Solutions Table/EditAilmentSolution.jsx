    ...
    return (
        <section>
            <div className='form__header'>
                ...
                <Button className='form__button' variant='contained' sx={{ borderRadius: '5rem' }} onClick={updateEffectiveSolution}>Update Ailment Solution</Button>
            </div>
...
export default EditAilmentSolution
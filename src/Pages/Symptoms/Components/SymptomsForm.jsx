...
const SymptomsForm = React.memo((props) => {
    const { state, dispatch, ACTION_TYPE } = props;

    const [anchorElBodySystem, setAnchorElBodySystem] = useState(null);
    ...
    const [anchorElSymptoms, setAnchorElSymptoms] = useState(null);
